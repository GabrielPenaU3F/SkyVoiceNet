...
dataset = DataLoader.load_processed_data('nus_processed_3.h5', dataset='variable')
# dataset = DataLoader.load_processed_data('reduced_dataset_3.h5', dataset='variable')
...
output_png = os.path.join(path_dir, 'loss_3_full_cat_30_batch4.png')
