...
# Reconstruct
player = AudioPlayer()
audio_1, sr_1 = player.play_audio_from_spectrogram(predicted_1, sr=16000, compression_factor=3, denoising_strength=0.2, mode='return')
audio_2, sr_2 = player.play_audio_from_spectrogram(predicted_2, sr=16000, compression_factor=3, denoising_strength=0.2, mode='return')

wavfile.write('Example 1.wav', sr_1, audio_1)
wavfile.write('Example 2.wav', sr_2, audio_2)
